            ...
            <div id="block">
                <div className="head" style={{ backgroundColor: this.props.state.me.color }}>
                    {window.innerWidth < 768 ? (
                        <>
                            <FontAwesomeIcon className="arrow" icon={faArrowLeft} onClick={this.props.showMobileBack} />

                            {this.props.state.display && this.props.state.show ? (
                                <>
                                    <img className="header-photo" src={this.findUser(this.props.state.display).photo} alt={this.findUser(this.props.state.display).username} onClick={this.displayUser} />
                                    <div className="user-name" style={{ top: "10px", left: "80px", color: "#fff", cursor: "pointer" }} onClick={this.displayUser}>
                                        {this.findUser(this.props.state.display).firstname}
                                        {this.findUser(this.props.state.display).lastname}
                                    </div>

                                    {this.findUser(this.props.state.display) && this.findUser(this.props.state.display).last_activity && Date.now() - this.findUser(this.props.state.display).last_activity < 180000 ? (
                                        ...
                                        <div className="last-activity">{this.findUser(this.props.state.display) && convertUNIX(this.findUser(this.props.state.display).last_activity)}</div>
                                    )}
                                </>
                            ) : null}
                        </>
                    ...
                    <table className="right-side">
                        <tbody>
                            <tr>
                                <td>
                                    <span title="Edit your profile" id="edit-profile" onClick={this.props.editProfile}>
                                        <FontAwesomeIcon icon={faUser} />

                                        {this.props.state.me && this.props.state.me.friends_requests && this.props.state.me.friends_requests.length > 0 ? (
                                ...
                                <td>
                                    <FontAwesomeIcon id="logout" icon={faSignOutAlt} onClick={this.props.logout} />
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div className="box">
                    <div id="left">
                        <Users display={this.props.display} state={this.props.state} sendFriendRequest={this.props.sendFriendRequest} revokeFriendRequest={this.props.revokeFriendRequest} removeFriend={this.props.removeFriend} />
                    </div>
                    <div id="center">
                        <Message state={this && this.props.state} updateData={this.props.updateData} scrollUP={this.props.scrollUP} profileChange={this.props.profileChange} />

                        {this.props.state.me && this.props.state.me.friends && this.props.state.me.friends.some(el => el === this.props.state.display) ? (
                            <div id="inputMessage" style={{ backgroundColor: this.props.state.me.color + "52" }}>
                                ...
                                <input type="text" placeholder="Your message" onChange={this.props.updateData} id="message" name="message" autoComplete="off" onKeyDown={this.props.keyEnter} value={this.props.state.message} />

                                <span>
                                    <input type="submit" id="submit" style={{ backgroundColor: this.props.state.me.color }} value="Send" onClick={this.props.sendMessage} />
                                </span>
                            </div>
                        ) : null}
                    </div>
